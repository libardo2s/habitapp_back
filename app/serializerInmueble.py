...
class InmuebleSerializar(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'usuarioInmueble', 'direccion', 'barrio', 'precio',
                  ...
                  'wifi', 'ciudad',
                  'accesible', 'almuerzo', 'amueblado', 'tv', 'lavado',
                  'mascota', 'fumador', 'piscina', 'portero', 'camarote',
                  'espacio_estudio', 'pareja', 'aire_acondicionado', 'fechaEntrada', 
                  'fechaSalida', 'instancia', 'foto', 'hombre', 'mujeres', 'estado', 'comentarios', 'valoracionPromedio','propietario', 'telefono_propietario')
